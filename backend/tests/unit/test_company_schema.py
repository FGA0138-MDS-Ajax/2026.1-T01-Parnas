...
class TestCompanySchemaIntegration:
    ...
    def test_extra_fields_are_ignored(self, schema):
        """CENÁRIO: Dados com campos extras - devem ser ignorados"""
        data = {
            'name': 'Empresa Teste',
            'cnpj': '11.222.333/0001-81',
            'email': 'teste@empresa.com',
        ...
        assert 'outro_extra' not in result
        assert len(result) == 4  # Apenas os 4 campos esperados
