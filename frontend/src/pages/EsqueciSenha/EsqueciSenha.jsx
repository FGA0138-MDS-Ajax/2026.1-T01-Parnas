...
export function EsqueciSenha() {
  ...
  async function handleRequestToken(event) {
    ...
    try {
      ...
      const rawToken = data.reset_link.substring(data.reset_link.lastIndexOf('/') + 1);
      ...
      <div className="forgot-password-card">
        ...
        {!token ? (
          <form className="forgot-password-form" onSubmit={handleRequestToken}>
            ...
            <a className="forgot-password-link" href="/">Voltar para login</a>
          </form>
        ) : (
          <form className="forgot-password-form" onSubmit={handleResetPassword}>
            ...
            <div className="forgot-password-field-group" style={{ marginTop: '15px' }}>
              <label className="forgot-password-label">Confirmar Nova Senha</label>
              <input
                className="forgot-password-input"
                type="password"
                placeholder="••••••••"
            ...
            <a className="forgot-password-link" href="/">Cancelar</a>
          </form>
        )}
      </div>
    </section>
